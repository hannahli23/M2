 ...
 */
    public class AntLabMain {
        ...
        */public void printOutMessage() {
            ...
            Person1 p1 = new Person1("Kaylee Correll");
		    toPrint += p1.toString("kcorrell6");

		    Person2 p2 = new Person2("Brandon");
		    toPrint += p2.toString("bolson31");

		    Person3 p3 = new Person3("Molly");
		    toPrint += p3.toString("903210883");

		    Person4 p4 = new Person4("Weixi Li");
